                    ...
                    <CardTitle>
                      ...
                      <CardImgOverlay>
                        <div className="milky-background">
                            <h5 className="card-title col-9 sport-event-name">{sportEvent.name}</h5>
                            {/* <div className="col-3">
                      ...
                      <Media>
                        <Media right middle>
                          <Media object className="card-country-flag" src={`assets/images/country-flags/svg/${sportEvent.countryCode}.svg`} alt="" />
                        </Media>
